...
@property (assign, nonatomic) long long ID; // 用户UID
...
@property (assign, nonatomic) BOOL geo_enabled; // 是否允许标识用户的地理位置
@property (assign, nonatomic) BOOL verified; // 是否是微博认证用户，即加V用户
@property (assign, nonatomic) NSInteger verified_type; // 暂未支持
@property (copy, nonatomic) NSString *remark; // 用户备注信息，只有在查询用户关系时才返回此字段
@property (strong, nonatomic) Status *status; // 用户的最近一条微博信息字段 详细
...
@property (copy, nonatomic) NSString *lang; // 用户当前的语言版本，zh-cn，zh-tw，en
